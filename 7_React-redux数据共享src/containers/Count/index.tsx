...
import {createIncrementAct,createDecrementAct,createIncrementAsyncAct} from '../../redux/actions/count';
...
const CountContainer:any = connect(
    mapStateToProps,
    {
        jia:createIncrementAct,
        jian:createDecrementAct,
        jiaAsync:createIncrementAsyncAct
    }
    )(Count)
